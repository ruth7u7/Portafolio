...
function ProjectHeader() {
  return (
    <div className="title-project flex justify-content-start align-items-center">
      <p className="mr-4">Proyectos personales</p>
      <svg
...
export default function Project({
  ...
  const showPersonal = groups.includes("personal");
  ...
  return (
    <div className="projects-container">
      ...
      {showPersonal && (
        <>
          <div className="project-information project-information--grid">
            <ProjectTemplate
              image={project10}
              title="Gestor de tareas"
              description="Primera fase de un gestor de tareas con repositorio de referencia."
              prjSkills={stack6}
              isPrivate
            ...
            <ProjectTemplate
              ...
              description="Gestión de servicios a domicilio con opción Web 3.0."
              prjSkills={stack5}
