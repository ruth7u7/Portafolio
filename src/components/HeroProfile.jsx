  ...
  return (
    <div className="hero-profile">
      <div className="profile-wrapper">
        <img src={profile} alt="Ruth Grecia Peña Valdez" className="profile-photo" />
      </div>      <p className="name">Ruth Grecia Peña Valdez</p>
      <div className="icons flex justify-content-center align-items-center">
